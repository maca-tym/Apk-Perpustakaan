...
<div class="max-w-2xl mx-auto">
    <div class="card p-8">
        ...
        <h2 class="text-2xl font-semibold mb-6">Tambah Buku Baru</h2>
        ...
        <form method="POST" action="{{ route('books.store') }}">
            ...
            <div class="mt-6">
                ...
                <textarea name="deskripsi" 
                          rows="4"
                          class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500">{{ old('deskripsi') }}</textarea>
            </div>
